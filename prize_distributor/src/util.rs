...
pub fn divide_by_decimals(big_float_amount: BigDecimal, decimals: u8) -> BigDecimal {
...
pub fn to_big_decimal(price_str: &str, decimals: u8) -> Result<BigDecimal, ParseBigDecimalError> {
